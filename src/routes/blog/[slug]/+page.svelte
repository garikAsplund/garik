<script lang="ts">
	import { BookOpenCheck, ChevronLeft, ChevronRight, MoveLeft, ArrowUp } from 'lucide-svelte';
...
<article class="mx-auto max-w-screen-lg px-8 py-12">
	...
	<div class="relative mt-8 flex justify-center xl:translate-x-36">
		...
		<aside class="sticky top-20 hidden h-fit w-96 pl-12 opacity-75 xl:block">
